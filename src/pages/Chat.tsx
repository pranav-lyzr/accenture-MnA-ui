...
import api, { ChatSessionSummary, ChatMessage, ChatMessageCreate } from "../services/api";
...
const Chat = () => {
  ...
  const handleAddToCollection = (collectionId: string | null, collectionName?: string) => {
    ...
    alert(`Successfully added ${selectedCompanies.length} companies to ${collectionName || 'collection'}!`);
    setSelectedCompanies([]);
  };
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-semibold text-blue-900">Company Search Results</h3>
                </div>
                <p className="text-sm text-blue-800">
                  Found {extractedJson.total_results} companies matching your criteria
                </p>
                <div className="mt-2">
              ...
              <div className="grid gap-4">
                {extractedJson.companies?.map((company: any, idx: number) => (
                  <CompanyCard
                    key={idx}
                    company={company}
                    isSelected={selectedCompanies.some(c => c.name === company.name)}
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-semibold text-green-900">Company Profile</h3>
                </div>
              ...
              <SingleCompanyProfile companyProfile={extractedJson.company_profile} />
            </div>
          );
  ...
  const currentSessionSummary = chatSessions.find(s => s.session_id === currentSessionId);

  return (
    <Layout>
      <div className="flex flex-col h-[calc(100vh-81px)] bg-gray-50">
        {/* Header */}
                        ...
                        chatSessions.map((session) => (
                          <button
                            ...
                            className={`w-full text-left p-2 rounded-md hover:bg-gray-50 transition-colors ${
                              currentSessionId === session.session_id ? 'bg-purple-50 border border-purple-200' : ''
                            }`}
                          >
                            <p className="text-sm font-medium text-gray-900 truncate">{session.first_message || "(No message)"}</p>
          ...
          <div className="max-w-4xl mx-auto px-4 py-4">
            ...
            {messages.length === 0 && !newSessionPending && (
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Hello! How can I assist you with M&A?</h3>
                <p className="text-gray-600 mb-6 max-w-md mx-auto">I'm here to help with mergers, acquisitions, due diligence, valuations, and integration strategies.</p>
                  ...
                  {suggestedQuestions.map((suggestion, index) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-gray-900 font-medium leading-relaxed">{suggestion}</p>
                      </div>
                    </button>
                  ))}
                </div>
            ...
            {messages.length === 0 && newSessionPending && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 max-w-md mx-auto">Type your question below to start a new conversation.</p>
              </div>
            )}
                ...
                {message.message && (
                  <div className="flex justify-end mb-4">
                    <div className="flex items-start gap-3 max-w-[85%] flex-row-reverse">
                      ...
                      <div className="px-4 py-3 rounded-2xl rounded-br-md bg-purple-600 text-white">
                ...
                {message.response && (
                  <div className="flex justify-start mb-4">
                    <div className="flex items-start gap-3 max-w-[95%]">
                      ...
                      <div className="px-4 py-3 rounded-2xl rounded-bl-md bg-white border border-gray-200 text-gray-900 shadow-sm flex-1">
        ...
        <div className="bg-white border-t border-gray-200 p-4 flex-shrink-0">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-end gap-3 bg-gray-50 rounded-2xl border border-gray-200 p-3 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all">
              <textarea
                value={inputMessage}
                onChange={(e) => setInputMessage(e.target.value)}
                onKeyDown={handleKeyDown}
                placeholder="Ask me anything about M&A..."
                className="flex-1 bg-transparent focus:outline-none text-gray-900 placeholder-gray-500 resize-none min-h-[24px] max-h-32"
                disabled={isLoading}
                rows={1}
                style={{
                  height: 'auto',
              ...
              <Button
                ...
                className="rounded-xl bg-purple-600 hover:bg-purple-700 text-white h-10 w-10 flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
